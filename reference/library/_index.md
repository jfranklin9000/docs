...
[`++call:wa`](@/docs/reference/library/5e.md#call-wa)
...
[`++mint:wa`](@/docs/reference/library/5e.md#mint-wa)
...
[`++neat:wa`](@/docs/reference/library/5e.md#neat-wa)
[`++ned:fl`](@/docs/reference/library/3b.md#ned-fl)
[`++need`](@/docs/reference/library/2a.md#need)
[`++nell:wa`](@/docs/reference/library/5e.md#nell-wa)
[`++nest:wa`](@/docs/reference/library/5e.md#nest-wa)
[`++net:fe`](@/docs/reference/library/2c.md#net-fe)
[`++nets:wa`](@/docs/reference/library/5e.md#nets-wa)
...
[`++open:wa`](@/docs/reference/library/5e.md#open-wa)
...
[`++pi-heck`](@/docs/reference/library/5g.md#pi-heck)
[`++pi-mope`](@/docs/reference/library/5g.md#pi-mope)
[`++pi-moth`](@/docs/reference/library/5g.md#pi-moth)
[`++pi-mumm`](@/docs/reference/library/5g.md#pi-mumm)
[`++pi-noon`](@/docs/reference/library/5g.md#pi-noon)
[`++pi-tell`](@/docs/reference/library/5g.md#pi-tell)
...
[`++play:wa`](@/docs/reference/library/5e.md#play-wa)
...
[`++slam:wa`](@/docs/reference/library/5e.md#slam-wa)
[`++slap:wa`](@/docs/reference/library/5e.md#slap-wa)
...
[`++slot:wa`](@/docs/reference/library/5e.md#slot-wa)
[`++slug`](@/docs/reference/library/4f.md#slug)
[`++slym:wa`](@/docs/reference/library/5e.md#slym-wa)
...
[`++stop:wa`](@/docs/reference/library/5e.md#stop-wa)
...
[`++wa`](@/docs/reference/library/5e.md#wa)
